...
public final class BouncyBar extends Bar {
	
	public BouncyBar(TextureRegion barRegion, float angle, BAR_NAME name, float x, float y, float RATIO, World world) {
		...
		barFixtureDef.restitution = 0.9f;
	...
	public void createBody() {
		...
		loader2.attachFixture(barBody, "BouncyBar", barFixtureDef, this.width/this.RATIO);
	}
